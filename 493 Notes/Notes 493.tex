...
\begin{figure}[H]
\begin{center}
\includegraphics[width = 0.60\hsize]{./figures/ConvergingConnection.png} % this includes the figure and specifies that it should span 0.7 times the horizontal size of the 
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = 0.70\hsize]{./figures/DivergingConnection.png} % this includes the figure and specifies that it should span 0.7 times the horizontal size of the 
...
\begin{align*}
\lambda_C(a_i)& = \sum_{j=1}^m \pi_C (b_j) \sum_{k=1}^n P(c_k \vert a_i \cap b_j) \lambda(c_k)\\
\lambda(c_k) & = 1, \forall c_k\\
\lambda_C(a_i)& = \sum_{j=1}^m \pi_C (b_j) 
\end{align*}
\end{itemize}
