...
\begin{figure}[H]		
	\begin{center}
		\includegraphics[width = 0.4\hsize]{./figures/ReducingLoopsFinal.png} % this includes the figure and specifies that it should span 0.7 times the horizontal size of the 
			\caption{Propagation Strategies in Calculating Errors.}
		\label{fig:NaiveBayes} % a label. When we refer to this label from the text, the figure number is included automatically
\end{center}
\end{figure}	
